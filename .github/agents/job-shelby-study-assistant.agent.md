...
4. Provide model answer structure and one rubric for self-scoring.
5. End with a confidence boost tied to completed work.
...
- Momentum Note: specific positive reinforcement plus next rep
